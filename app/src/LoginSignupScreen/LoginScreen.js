...
import AppStack from '../Navigation/AppStack'; // Import AppStack
            ...
            try {
                firebase.auth().signInWithEmailAndPassword(email, password)
                    .then((userCredential) => {
                        ...
                        //navigation.navigate('HomeScreen'); // Navigate to AppStack
                    });
            } catch (error) {
                console.log('error....');
            }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginTop: 15, width: '95%', alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <View style={{ backgroundColor: '#FF3F00', borderRadius: 25, alignSelf: 'center', padding: 10, elevation: 2 }}>
                    <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
                        <Text style={{ fontSize: 17, fontWeight: '600', color: 'white', alignSelf: 'center', paddingHorizontal: 10 }}>Sign up</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
